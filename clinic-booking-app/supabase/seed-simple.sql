...
-- 3. Link clinic with specialties
...
-- 4. Insert time slots for tomorrow
...
SELECT 
  ...
  true
FROM clinics c,
UNNEST(ARRAY['08:00', '09:00', '10:00', '14:00', '15:00']::time[]) AS slot_time
WHERE c.email = 'contact@abc.com';

-- 5. Insert time slots for day after tomorrow
INSERT INTO time_slots (clinic_id, date, start_time, end_time, is_available)
SELECT 
  c.id,
